...
class TestEnrichEndpoint:
    ...
    def test_enrich_starts_task(self, mock_task, client):
    ...
    @patch("main.enrich_linkedin_task")
    def test_enrich_with_encoded_url(self, mock_task, client):
        mock_result = MagicMock()
...
class TestTaskStatusEndpoint:
    ...
    def test_task_pending(self, mock_async_result, client):
        mock_result = MagicMock()
    ...
    @patch("main.AsyncResult")
    def test_task_unknown_state(self, mock_async_result, client):
        mock_result = MagicMock()
